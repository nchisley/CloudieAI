  document.addEventListener('DOMContentLoaded', () => {
    ...
    // If you want to use 1 week instead, change to:
    // const HISTORY_EXPIRATION = 7 * 24 * 60 * 60 * 1000;
    ...
    function initChat() {
      ...
      if (history.length > 0) {
        ...
        // Clear current log first (optional, if you want to avoid duplicates)
        chatLog.innerHTML = "";
        history.forEach(msg => {
          const bubble = document.createElement('div');
      ...
      async function sendMessage() {
        ...
        // Append user's message and update history.
